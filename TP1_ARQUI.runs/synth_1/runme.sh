...
HD_PWD='C:/Users/nehemias/Desktop/facu/repo/TP1_ARQUI/TP1_ARQUI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TP1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TP1.tcl
