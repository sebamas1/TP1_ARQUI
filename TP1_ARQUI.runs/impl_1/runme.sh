...
HD_PWD='C:/Users/nehemias/Desktop/facu/repo/TP1_ARQUI/TP1_ARQUI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TP1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TP1.tcl -notrace
